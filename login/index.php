          ...
          <div class="card-body">
            ...
            <form id="formAuthentication" class="mb-3" action="login.php" method="post">
              ...
              <?php if (isset($_SESSION["message"])) : ?>
                ...
                <?php endif; ?> 
                <div class="mb-3">
                  <label for="email" class="form-label">Foydalanuvchi nomi</label>
                  <input type="text" class="form-control" id="login" name="login" placeholder="Foydalanuvchi nomi" autofocus />
                </div>
